...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    , ((modm .|. shiftMask, xK_g), sendMessage $ setGaps [(L,5), (R,5), (U,5), (D,10)]) -- reset the GapSpec
    ...
    , ((modm .|. shiftMask, xK_v     ), spawn "exec ~/bin/compositorp")
...
myStartupHook = do
  ...
  --spawnOnce "feh --bg-scale ~/wallpapers/seele-vollerei-honkai-impact-raining-street-transparent-umbrella-bubble-gum-anime-40215.jpeg"
  spawnOnce "feh --bg-scale ~/wallpapers/"
...
-- original from the dotfiles thingy
--main = do
...
-- some reason xmobar works with this
main = do  { xmonad =<< statusBar myBar myPP toggleStrutsKey defaults }
--main = do
...
defaults = def {
      ...
      -- hooks, layouts
        ...
        layoutHook = gaps [(L,5), (R,5), (U,5), (D,10)] $ spacingRaw True (Border 10 10 10 10) True (Border 10 10 10 10) True $ smartBorders $ myLayout,
